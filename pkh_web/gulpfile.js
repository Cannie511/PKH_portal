...
var webpackConfigCustomer = require('./webpack_customer.config.js')
...
elixir(function (mix) {
  ...
  var assets = [
   ...
   mix
    ...
    // theme 2
    .sass('./public/frontend/theme2/scss/*.scss', 'public/frontend/theme2/css/theme.css')    
    // .version(assets)
    // .browserSync({
    //   proxy: 'phankhangco.local'
    // })
    // .karma({
    //   jsDir: karmaJsDir
    // })
