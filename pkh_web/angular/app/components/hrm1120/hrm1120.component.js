class Hrm1120Controller{
    ...
    $onInit(){
        ...
        let previousSearch = sessionStorage.hrm1120;
    ...
    doSearch(page) {
        ...
        let searchService = this.API.service('search', this.API.all('hrm1120'));
        param.page = page;
    ...
    download() {
        let param = angular.copy(this.m.filter);
        let service = this.API.service('download', this.API.all('hrm1120'));
        service.post(param)
            .then((response) => {
