class Hrm1100Controller{
    ...
    $onInit(){
        ...
        let previousSearch = sessionStorage.hrm1100;
    ...
    loadInit() {
        let param = {};
        this.API.service('init-data', this.API.all('hrm1100'))
            .post(param)
            .then((response) => {
    ...
    doSearch(page) {
        ...
        let searchService = this.API.service('search', this.API.all('hrm1100'));
        param.page = page;
