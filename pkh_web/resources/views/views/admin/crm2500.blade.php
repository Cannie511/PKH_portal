<section class="content-header">
    <h1>Danh sách vật phẩm<small></small></h1>
    <ol class="breadcrumb">
        <li><a ui-sref="app.landing"><i class="fa fa-dashboard"></i><span translate="BREADCRUMBS_HOME"></span></a></li>
        <li class="active">Danh sách vật phẩm</li>
    </ol>
</section>
        ...
        <div class="col-md-12">
            <div class="box box-info">
                <div class="box-header with-border">
                    <h3 class="box-title">Danh sách vật phẩm</h3>
                    <div class="box-tools pull-right">
                        <a ui-sref="app.crm2510" class="btn btn-success btn-xs"><i class="fa fa-plus"></i>&nbsp;{{'COM_BTN_NEW' | translate}}</a>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 col-sm-6 col-xs-12">
                                <div class="form-group">
                                    <label for="name">Loại vật phẩm</label>
                                    <select class="form-control" ng-model="vm.m.filter.type">
                                    ...
                                    <td class="col-action">
                                        <div class="btn-group" uib-dropdown dropdown-append-to-body>
                                          ...
                                          <ul class="dropdown-menu" uib-dropdown-menu role="menu" aria-labelledby="btn-append-to-body">
                                            <li ng-if="vm.can('screen.crm2510')" role="menuitem"><a ui-sref='app.crm2511({product_market_id: item.product_market_id})' translate="COM_BTN_EDIT"></a></li>
                                          </ul>
                                        </div>
                                    </td>
