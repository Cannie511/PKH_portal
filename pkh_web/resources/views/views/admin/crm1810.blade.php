<section class="content-header">
    <h1>Loại chi phí<small></small></h1>
    <!-- <ol class="breadcrumb">
        ...
        <div class="col-md-12">
            <div class="box box-info">
                <div class="box-header with-border">
                    <h3 class="box-title">Danh sách loại chi phí</h3>
                    <div class="box-tools pull-right">
                        <div uib-dropdown class="btn-group">
                            <a ui-sref="app.crm1811" class="btn btn-success btn-xs"><i class="fa fa-plus"></i>&nbsp;{{'COM_BTN_NEW' | translate}}</a>
                        </div>
                    </div>
                </div>
                                    ...
                                    <td class="col-action">
                                        <div class="btn-group" uib-dropdown dropdown-append-to-body>
                                          ...
                                          <ul class="dropdown-menu" uib-dropdown-menu role="menu" aria-labelledby="btn-append-to-body">
                                            <li  role="menuitem"><a ui-sref='app.crm1811({cost_cat_id: item.cost_cat_id})'>Chỉnh sửa</a></li>
                                          </ul>
                                        </div>
                                    </td>
