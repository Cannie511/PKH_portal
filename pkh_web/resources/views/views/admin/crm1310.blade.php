<section class="content-header">
    <h1>Tạo đơn đặt hàng nhà máy <small></small></h1>
    <ol class="breadcrumb">
        <li><a ui-sref="app.landing"><i class="fa fa-dashboard"></i><span translate="BREADCRUMBS_HOME"></span></a></li>
        <li><a ui-sref="app.crm1300">Danh sách đơn hàng nhà máy</a></li>
        <li class="active">Tạo đơn hàng nhà máy</li>
    </ol>
</section>
        ...
        <div class="col-md-9" >
            <div class="box box-info">  
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                <tr ng-repeat='item in vm.m.orderDetail'>
                                    ...
                                    <td >{{item.amount * item.unit_price | currency : '' : 2 }}</td>
                ...
                <div class="box-footer">
                    <a ui-sref="app.crm1300" class="btn btn-default"><i class="fa fa-angle-double-left"></i> Back</a>
                    <div class="pull-right">
                        ...
                        <button type="button" class="btn btn-warning m-l" ng-disabled="vm.m.orderDetail.length == 0" ng-click="vm.clickSave()" ><i class="fa fa-save fa-fw"></i>Lưu</button> 
                    </div>
                </div> 
            </div>
...
<div class="box box-info">
    <div class="box-header with-border">
        <h3 class="box-title">Thông tin supplier</h3>
        <div class="box-tools pull-right">
    ...
    <div class="box-body">
        <div class="row" >
            <div class="col-md-12">
                <label>Mã supplier</label>
                <p class="form-control-static"><a ui-sref='app.crm2600({store_id: vm.m.store_id})'>#{{vm.m.supplier.supplier_id}}</a></p>
            </div>
            <div class="col-md-12" >
                <label>Tên supplier</label>
                <p class="form-control-static">{{vm.m.supplier.name}}</p>
            </div>
            
            <div class="col-md-12">
                <label>Địa chỉ</label>
                <p class="form-control-static">{{vm.m.supplier.address}}</p>
            </div>
         
            <div class="col-md-12">
                <label>Người liên hệ</label>
                <p class="form-control-static">{{vm.m.supplier.contact_name}}</p>
            </div>
            
            <div class="col-md-12">
                <label>Điện thoại</label>
                <p class="form-control-static">{{vm.m.supplier.contact_tel}}</p>
            </div>
            <div class="col-md-12">
                <label>Email</label>
                <p class="form-control-static">{{vm.m.supplier.contact_email}} </p>
            </div>
