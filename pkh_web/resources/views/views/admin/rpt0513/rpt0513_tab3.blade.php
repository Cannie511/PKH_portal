<div class="box box-info">
    <div class="box-header with-border">
        <h3 class="box-title">Giao hàng cho đại lý</h3>
        <p> 
            Note:
            <br>
            Dữ liệu giao hàng cho đại lý không bao gồm giao hàng bảo hành và hàng mẫu.
            <br>   <br>
            ...
            <br>
            Bar chart: Timemode - Tab name - Loai du lieu - Loai san pham  - column name - Vung - Tinh/thanh - NVBH 
            <br>   <br>
            Màn hình chi tiết tham khảo: https://portal.phankhangco.com/#/crm0400  (tab xuất kho - vận chuyển - khách nhận - hoàn tất)
        </p>
    </div>
