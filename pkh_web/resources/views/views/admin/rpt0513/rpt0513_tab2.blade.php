<div class="box box-info">
    <div class="box-header with-border">
        <h3 class="box-title">Nhập hàng nhà máy</h3>
        <p> 
            Nhập hàng từ WATERTEC
            <br>
            Line chart: Tab name - product name - loai du lieu
            <br>
            Bar chart: Timemode - Tab name - column name - Loai san pham - Loai du lieu
            <br>   <br>
            Màn hình chi tiết tham khảo: 
            <br>
            https://portal.phankhangco.com/#/crm1600
            <br>
            https://portal.phankhangco.com/#/crm0920
        </p>
    </div>
            ...
            <div  class="row">
                <div  class="col-md-3 col-sm-6 m-b-xs">
                    <div class="form-group">
                        ...
                        <select class="form-control" ng-model="vm.m[vm.m.activeFlag].filter.data_type"  >
                            <!-- <option value="">Null</option> -->
                            <option value="1">Số lượng</option>
                            <option value="2">Số tiền USD</option>    
                        </select>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6 m-b-xs">
