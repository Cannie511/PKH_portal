<div class="row" ng-if="vm.m.activeFlag == 4" >
        <div class="col-md-12">
            <div class="box box-info">
                <div class="box-header with-border">
                    <h3 class="box-title">Danh sách yêu cầu huỷ nhập kho hàng nhà máy</h3>
                        ...
                        <table class="table table-striped">
                            <thead>
                                <tr>
                                    ...
                                    <th style="width:120px">EXIM code</th>
                                    <th style="width:100px">Yêu cầu</th>
                                    <th style="width:100px">Trạng thái</th>
                                    <th style="width:240px">Nơi xuất</th>
                                    <th style="width:240px">Nơi nhập</th>
                                    <th style="width:240px">Giá trị</th>
                            ...
                            <tbody>
                                <tr ng-repeat='item in vm.m[vm.m.activeFlag].data.data'>
                                    ...
                                    <td>
                                        <a ui-sref='app.crm2311({warehouse_exim_id: item.ref_id})'>Chi tiết>></a>
                                    </td>
                    ...
                    <div class="row" ng-if="vm.m[vm.m.activeFlag].data.from > 0">
                        ...
                        <div class="col-md-6 col-sm-12 text-right">
                            <uib-pagination ng-show="vm.m[vm.m.activeFlag].data.from > 0"
                                ...
                                ng-change="vm.doSearch(4, vm.m[vm.m.activeFlag].data.current_page)"
