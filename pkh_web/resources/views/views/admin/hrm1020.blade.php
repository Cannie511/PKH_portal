                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                <tr ng-repeat='item in vm.m.list.data'>
                                    ...
                                    <td>
                                        <a ng-if="vm.can('screen.hrm1021')" ui-sref="app.hrm1021({id: item.id})" clsas="btn btn-xs" ng-class="{'not-read': item.viewed == '0'}">
                                            {{item.title}}
                                        </a>
                                    </td>
