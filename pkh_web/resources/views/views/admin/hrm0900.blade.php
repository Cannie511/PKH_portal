<section class="content-header">
    <h1>Ngày lễ<small></small></h1>
    <ol class="breadcrumb">
        <li><a ui-sref="app.landing"><i class="fa fa-dashboard"></i><span translate="BREADCRUMBS_HOME"></span></a></li>
        <li class="active">Ngày lễ</li>
    </ol>
</section>
        ...
        <div class="col-md-12">
            <div class="box box-info">
                <div class="box-header with-border">
                    <h3 class="box-title">Ngày lễ</h3>
                    <div class="box-tools pull-right">
                        <a ui-sref="app.hrm0910()" class="btn btn-info btn-xs"><i class="fa fa-plus"></i>&nbsp;{{'COM_BTN_NEW' | translate}}</a>
                    </div>
                </div>
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                <tr ng-repeat='item in vm.m.list.data'>
                                    ...
                                    <td>{{item.amount}}</td>
                                    <td>
                                        <a ng-if="vm.can('screen.hrm0910')" class="btn btn-xs btn-info" ui-sref="app.hrm0910({id: item.id})"><i class="fa fa-eye fa-fw"/></a>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
