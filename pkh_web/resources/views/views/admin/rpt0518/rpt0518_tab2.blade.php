<div class="tab-pane" ng-class="{'active': vm.m.activeFlag == 2}">
    <div class="box box-info">
            <div class="box-header with-border">
                <h3 class="box-title">Doanh số giao hàng - (Đơn vị tiền tệ: 1.000 VND)</h3>
                <p>
                    <br>
                    Line chart: Year - Tab name - store name - loai du lieu
                    <br>
                    Bar chart: Timemode - Tab name - column name - Vung - Tinh/thanh - NVBH - Loai du lieu
                </p>
            </div>
