        ...
        <table class="table no-border" cellpadding="0" cellspacing="0">
            <tr>
                <td style="padding-left: 5px">
                    <span>Đơn vị bán hàng: Công ty TNHH PHAN KHANG HOME</span><br/>
                    <span>Địa chỉ: 63, đường số 30,  Phường Tân Phong, Quận 7</span><br/>
                    <span>Hotline:  (+84)90-6610-116</span><br/>
                    <span>Mã số thuế: 0313993571</span>
                </td>
                <td class="text-right">
                    <span></span>
            ...
            <table class="table" cellpadding="0" cellspacing="0">
                <thead>
                    <tr class="row-header">
                        ...
                        <th style="width: 165px;">Mã sản phẩm</th>
                        <th style="width: 150px;">Hình ảnh</th>
                        <th>Diễn giải</th>
                        <th style="width: 70px;">Màu</th>
                        <th style="width: 40px;">Năm BH</th>
                        <th style="width: 60px;">Đóng gói</th>
                        <th style="width: 60px;">Giá</th>
                        <th style="width: 50px;">Đặt hàng</th>
                    ...
                    <tbody>
                        ...
                        ?>
                            <?php foreach ($value as $item): ?>
                                <!-- <td>[[ $level[$index] ]]</td> -->
                                <?php if($level[$index]==1): ?>
                                    <tr>
                                        <td style="background-color:#065394;color:#fff;font-weight:bold" class="text-left" colspan="10">&nbsp;[[$item]]</td>
                                    </tr>
                                <?php endif; ?>
                                <?php if($level[$index]==2): ?>
                                    <tr>
                                        <td style="background-color:powderblue" class="text-left" colspan="10">&nbsp;[[$item]]</td>
                                    </tr>
                                <?php endif; ?>
                                <?php if($level[$index]==3): ?>
                                     <tr class='<?php if($rowIndex % 2 == 0) { echo "row1" ;} else {echo "row2";} ?>'>
                                        <td class="text-center">[[ $stt[$index] ]]</td>
                                        <td class="text-left product-code">&nbsp;[[$product[$index]['product_code'] ]]</td>
                                        <td class="text-center">
                                            <div class="img-container" style="padding: 3px; margin: auto">
                                                <img class="img" src="[[ $product[$index]['imgUrl'] ]]"/>
                                            </div>                                            
                                        </td>
                                        <td class="text-left">&nbsp;[[$product[$index]['name'] ]]</td>
                                        <td class="text-left">&nbsp;[[$product[$index]['color'] ]]</td>
                                        <td class="text-center">[[$product[$index]['warranty_year'] ]]</td>
                                        <td class="text-center">[[$product[$index]['standard_packing'] ]]</td>
                                        <td class="text-right">[[number_format($product[$index]['selling_price'])]]&nbsp;</td>
                                        <td></td>  
                                        <?php if(!empty($note[$index])): ?>
                                            <td class="text-left"> [[ $note[$index] ]]</td> 
                                        <?php else: ?>
                                            <td></td>
                                        <?php endif; ?>
                                        <?php $rowIndex++; ?>
