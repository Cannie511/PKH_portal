...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        <?php
            ...
            $pageNames[1] = "Kế toán";
            $pageNames[2] = "Lưu tạm";
            $pageNames[3] = "Khách hàng giữ";
        ?>
        <?php for($i = 0; $i < 4; $i++): ?>
        <table class="table no-border table-header" cellpadding="0" cellspacing="0">
            <!-- <tr>
            ...
            <tr  class="page-header-text-2">
                <td width="130px">
                    ...
                    <br/>
                    <i><span>Ngày in: [[date('Y-m-d H:i:s')]]</span></i>
                </td>
        ...
        <table id="store_info" class="table" cellpadding="0" cellspacing="0">
            ...
            <tr>
                ...
                <td colspan="3">
                    ...
                    <b>Tên tài khoản: PHAN HUU CHIEN</b>
                </td>
            </tr>
            <tr>
