                        ...
                        ?>
                            <?php foreach ($value as $item): ?>
                                ...
                                <?php if($level[$index]==1): ?>
                                    <tr>
                                        <td style="background-color:#065394;color:#fff;font-weight:bold" class="text-left" colspan="9">&nbsp;[[$item]]</td>
                                    </tr>
                                <?php endif; ?>
                                <?php if($level[$index]==2): ?>
                                    <tr>
                                        <td style="background-color:powderblue" class="text-left" colspan="9">&nbsp;[[$item]]</td>
                                    </tr>
                                <?php endif; ?>
                                <?php if($level[$index]==3): ?>
                                     <tr class='<?php if($rowIndex % 2 == 0) { echo "row1" ;} else {echo "row2";} ?>'>
                                        ...
                                        <td class="text-left" style="padding: 5px">
                                            <b style="font-size:14px">[[$product[$index]['product_code'] ]]</b>
                                            <br/>
                                            [[$product[$index]['name'] ]]
                                        </td>
