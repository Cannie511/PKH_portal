    ...
    public function handle()
    {
        ...
        if( $this->option("template")) {
            ...
            if( $template == "list" ||  $template == "create") {
                // $js = file_get_contents(__DIR__ . "/Stubs/AngularComponent/list.component.js.stub");
                $js = file_get_contents(__DIR__ . "/Stubs/AngularComponent/$template.component.js.stub");
            }
        }
        ...
        // }
        $this->createDirIfNotExist($folder);
        ...
        // create view (.php)
        File::put($folderView.'/'.$name.'.blade.php', $html);
