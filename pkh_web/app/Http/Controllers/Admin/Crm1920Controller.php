...
use App\Services\Crm1920Service;
use App\Services\DownloadService;
use App\Http\Controllers\Controller;

class Crm1920Controller extends Controller
{
    /**
     * @var mixed
     */
    protected $crm1920Service;

    /**
     * @param Crm1920Service $crm1920Service
     * @param DownloadService $downloadService
     */
    public function __construct(
        Crm1920Service $crm1920Service,
        DownloadService $downloadService
    ) {
        $this->crm1920Service  = $crm1920Service;
    ...
    public function postSearch(Request $request)
    {
        ...
        $list = $this->crm1920Service->selectList($param);
