!(function (modules) {
        ...
        var _extends =
            ...
            BookPropsBuilder = (function () {
                function BookPropsBuilder(onReady) {
                    console.log('cuong BookPropsBuilder', onReady);
                ...
                return (
                    ...
                    (BookPropsBuilder.prototype.calcSheets = function (pages) {
                        console.log('cuong calcSheets', pages,  Math.ceil(Math.max(0, pages - 4) / 2));
    ...
    function (module, exports, __webpack_require__) {
        ...
        var _extends =
                Object.assign ||
                function (target) {
                    console.log("cuong extend target", target);
                    for (var i = 1; i < arguments.length; i++) {
                        var source = arguments[i];
                        for (var key in source) Object.prototype.hasOwnProperty.call(source, key) && (target[key] = source[key]);
                    }
        ...
        (_libs.$.fn.FlipBook = function (options) {
            console.log('cuong FlipBook', options);
            console.log('cuong _LoadingController1', _LoadingController);
            console.log('cuong _BookController', _BookController);
            var scene = {
                dispose: function () {
                    this.ready
                    ...
                    function () {
                        _Detector2.default.webgl
                            ? ((scene.loadingCtrl = new _LoadingController2.default(scene.view, !0, function (progress) {
                                  console.log('cuong loading progress', progress);
                              ...
                              (scene.bookBuilder = function (props, sheets, pageCallback) {
                                  ...
                                  console.log('cuong bookBuilder', props, sheets, pageCallback);
                                  console.log('cuong get test', test);
                                  (scene.search = new _Search2.default(scene.view.getSearchView(), scene.book.getPages())),
                                      ...
                                      scene.book.addEventListener("searchResults", function (e) {
                                          console.log('cuong searchResults', e)
            ...
            Book = (function (_THREE$EventDispatche) {
                function Book(visual, sheets, pageCallback, props) {
                    ...
                    return (
                        ...
                        (_this.searchEngine.onPageHitsChanged = function (page, query) {
                            console.log('cuong onPageHitsChanged', page, query);
                ...
                return (
                    ...
                    (Book.prototype.getPages = function () {
                        console.log('cuong getPages', this.p.sheets,4 + 2 * this.p.sheets )
                    ...
                    (Book.prototype.addSheetBlock = function (p, block) {
                        console.log('cuong addSheetBlock', p, block);
                    ...
                    (Book.prototype.subscribeSheetBlock = function (block, offset) {
                        console.log('cuong subscribeSheetBlock', block, offset);
                        var _this5 = this,
                    ...
                    (Book.prototype.removeSheetBlock = function (block) {
                        console.log('cuong removeSheetBlock', block);
                    ...
                    (Book.prototype.removeSheetBlocks = function (first, size) {
                        console.log('cuong removeSheetBlocks', first, size);
                    ...
                    (Book.prototype.setRightCoverTexture = function (material, n) {
                        console.log('cuong setRightCoverTexture', material, n);
                    ...
                    (Book.prototype.splitSheetBlock = function (i, leftSize) {
                        ...
                        console.log('cuong splitSheetBlock', i, leftSize);
                    ...
                    (Book.prototype.mergeSheetBlocks = function (first, size) {
                        console.log('cuong mergeSheetBlocks', first, size);
                    ...
                    (Book.prepareProps = function (props) {
                        console.log('cuong prepareProps', props, _book);
                    ...
                    (Book.calcProps = function (props) {
                        console.log('cuong calcProps', props);
            ...
            BookController = (function (_Controller) {
                ...
                return (
                        ...
                        var _this2 = this,
                            handler = function () {
                                for (var pages = _this2.book.getTopPages(), visible = !1, _iterator = pages, _isArray = Array.isArray(_iterator), _i = 0, _iterator = _isArray ? _iterator : _iterator[Symbol.iterator](); ; ) {
                                    var _ref;
                                    console.log("cuong initLoadingAnimation", pages);
                                    if (_isArray) {
                                        if (_i >= _iterator.length) break;
                                        _ref = _iterator[_i++];
                                    } else {
                    ...
                    (BookController.prototype.cmdForward = function () {
                        var _this5 = this;
                        console.log('cuong cmdForward', this.getPage(), this.state, this)
                        this.state.singlePage
                            ? ((this.state.activeSide = (this.getPage() + 1) % 2),
                              this.state.activeSide
            ...
            BookPrinter = (function () {
                ...
                return (
                        ...
                        for (
                            var _this2 = this,
                                ...
                                _loop = function (page) {
                                    ...
                                    console.log('Cuong loop image:', page, info, head, pages)
                                    "image" === info.type
                    ...
                    (BookPrinter.prototype.renderImage = function (head, body, src) {
                        console.log("renderImage", head, body, src);
            ...
            BookView = (function (_View) {
                ...
                return (
                    ...
                    (BookView.prototype.getHandlers = function (id) {
                        console.log('cuong getHandlers', id)
                        var _this2 = this,
                            handlers = void 0;
                        return (handlers =
                            "inpPage" === id
                    ...
                    (BookView.prototype.getTemplate = function () {
                        return { html: "templates/default-book-view.html", styles: ["css/black-book-view.css"], links: [{ rel: "stylesheet", href: "css/font-awesome.min.css" }], script: "js/default-book-view.js" };
                    }),
                    BookView
                );
            })(_View3.default);
    ...
    function (module, exports, __webpack_require__) {
        ...
        var _BookPropsBuilder2 = __webpack_require__(9),
            ...
            ClbBookPropsBuilder = (function (_BookPropsBuilder) {
                console.log("cuong ClbBookPropsBuilder: ", _BookPropsBuilder);
                function ClbBookPropsBuilder(context, pageCallback, pages, onReady) {
                    _classCallCheck(this, ClbBookPropsBuilder);
                    console.log('cuong ClbBookPropsBuilder', context, pageCallback, pages, onReady)
        ...
        console.log('_BookPropsBuilder2', _BookPropsBuilder2);
        console.log('_BookPropsBuilder3', _BookPropsBuilder3);
        ...
        var _extends =
            ...
            Cover = (function (_SheetBlock) {
                function Cover(visual, p, angle, state) {
                    console.log('cuong Cover', visual, p, angle, state);
            ...
            CssLayersManager = (function () {
                ...
                return (
                    (CssLayersManager.prototype.getActives = function () {
                        var page = this.book.getPage(),
                            pages = this.book.getPages();
                        console.log('getActives', page, pages);
            ...
            PageManager = (function () {
                ...
                return (
                    ...
                    (PageManager.prototype.resolvePendings = function (pendings) {
                        console.log('cuong resolvePendings', pendings);
                        ...
                        console.log('cuong resolvePendings after', pendings);
                    }),
                    (PageManager.prototype.rtlPageN = function (n) {
                        console.log('cuong rtlPageN', n, this.p.rtl ? 2 * (this.p.sheets + 2) - 1 - n : n);
                        return this.p.rtl ? 2 * (this.p.sheets + 2) - 1 - n : n;
                    }),
                    (PageManager.prototype.load = function (material, n) {
                        console.log('cuong load', n)
                        var _this3 = this,
                        ...
                        console.log('cuong load 2', n, pi, p, o, this.loadings);
                                ...
                                if (o.texture) {
                                    ...
                                    (o.wrapper = _this3.imageFactory.build(pi, void 0 === pi.number ? n : pi.number, res.width, res.height, p.color, _this3.p.injector)),
                                        ...
                                        (o.wrapper.onLoad = function () {
                                            console.log('cuong onLoad', { type: "loadedPage", page: n });
                    ...
                    (PageManager.prototype.calcResolution = function (o) {
                        console.log('cuong calcResolution', o);
                        var res = void 0;
                    ...
                    (PageManager.prototype.loadPredictedPages = function () {
                        console.log('cuong loadPredictedPages', this.pageRequests, this.p.preloadPages);
                    ...
                    (PageManager.prototype.addPageRequest = function (n) {
                        console.log('cuong addPageRequest', n, this.pageRequests);
                    ...
                    (PageManager.prototype.getOrLoadTextureObject = function (material, n) {
                        console.log("cuong getOrLoadTextureObject", material, n);
                        var object = this.pageCache.get(n);
                    ...
                    (PageManager.prototype.setTexture = function (material, n) {
                        console.log("cuong setTexture", material, n);
