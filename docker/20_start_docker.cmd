...
docker run --name phpdev_container -d -it -p 80:80 --link mysql:db --mount type=bind,src="G:\TaskPKH\pkh_project\",dst="/opt/pkh_project" -w "/opt/pkh_project" phpdev /bin/bash
